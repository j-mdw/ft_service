...
mlb_yaml="srcs/$mlb_dir""metallb.yaml"
ngx_yaml="srcs/$ngx_dir""depl_nginx.yaml"
wp_yaml="srcs/$wp_dir""depl_wordpress.yaml"
pma_yaml="srcs/$pma_dir""depl_phpmyadmin.yaml"
msq_yaml="srcs/$msq_dir""depl_mysql.yaml"
cnf_map="srcs/service_configmap.yaml"
pv_yaml="srcs/persistent_volume.yaml"
secret_yaml="srcs/secrets.yaml"
ftp_yaml="srcs/$ftp_dir""depl_ftps.yaml"
tgf_yaml="srcs/$tgf_dir""depl_telegraf.yaml"
gfa_yaml="srcs/$gfa_dir""depl_grafana.yaml"
idb_yaml="srcs/$idb_dir""depl_influxdb.yaml"
